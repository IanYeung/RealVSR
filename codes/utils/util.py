...
if __name__ == '__main__':
    ...
    # batch_ker = random_batch_kernel(batch=30000, l=21, sig_min=0.2, sig_max=4.0, rate_iso=1.0, scaling=3, tensor=False)
    ...
    # prepro = SRMDPreprocessing(2, pca_matrix, random=True, para_input=10, kernel=21, noise=True, cuda=True,
    #                            sig=2.6, sig_min=0.2, sig_max=4.0, rate_iso=1.0, scaling=3, rate_cln=0.2,
    #                            noise_high=0.0)
